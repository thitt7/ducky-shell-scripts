A collection of whitehat scripts that are platform dependent and intended to be run as shell scripts by a rubber ducky device with mounted storage partition 
